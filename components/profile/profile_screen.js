...
import {
    ...
    Linking, Platform, ImageBackground, SafeAreaView, ActivityIndicator, Alert, BackHandler,
} from 'react-native';
...
export const Profile = ({ navigation }) => {
    ...
    function onLogout() {
        const removeKeys = ['areas', 'totalUnread', 'chats', 'pending', 'progress', 'history', 'allRequest', 'unread',]
